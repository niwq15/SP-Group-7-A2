...
## It takes the parameters n (making 2n boxes) and nreps (to make nreps simulations). In each simulation all the boxes are opened and 
## the lengths of all loops are counted. All the loop lengths are then tabulated and divided by nreps. 
## This creates a probability vector (prob_vec_y = probability of each loop length occurring at least once),
## and this is the output of the function. 
